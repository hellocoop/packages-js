 ...
 */
export class MissingClaimError extends EmailVerificationError {
 ...
 */
export class InvalidSignatureError extends EmailVerificationError {
 ...
 */
export class TimeValidationError extends EmailVerificationError {
 ...
 */
export class TokenFormatError extends EmailVerificationError {
    constructor(message: string) {
 ...
 */
export class JWKValidationError extends EmailVerificationError {
    constructor(message: string) {
 ...
 */
export class EmailValidationError extends EmailVerificationError {
    constructor(message: string) {
